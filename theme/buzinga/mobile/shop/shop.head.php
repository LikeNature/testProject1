		...
		<div id="hd_wr_inner">
			...
			<div id="hd_btn">
				...
				<div class="hd_right_btn">
					...
					<div class="hd_search btn_align">
						<div class="hd_sch_wrap">
							<form name="frmsearch1" action="<?php echo G5_SHOP_URL; ?>/search.php" onsubmit="return search_submit(this);">
								...
								<input type="text" name="q" value="" id="sch_str" placeholder="제품명을 검색해주세요" required>
					...
					<a href="<?php echo G5_SHOP_URL; ?>/cart.php" class="cart"><img src="https://atobien.co.kr/theme/buzinga/img/top_cart.svg" title=""><span class="sound_only">장바구니</span><span class="cart-count"><?php echo get_boxcart_datas_count(); ?></span></a>
					<?php if ($is_member) {  ?>
						<div class="btn_align">
							<button class="member_toggle tnb_btn"><img src="https://atobien.co.kr/theme/buzinga/img/top_member.svg" title=""><span class="sound_only">나의메뉴</span></button>
							<?php echo outlogin('theme/shop_basic'); // 외부 로그인 
							?>
						</div>
					<?php } else {  ?>
						<a href="<?php echo G5_BBS_URL ?>/login.php" class="tbn_btn">
							<img src="https://atobien.co.kr/theme/buzinga/img/top_member.svg">
